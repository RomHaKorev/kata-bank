...
import com.gitlab.bank.infra.persistence.ALISON
...
class AccountTest: EntityTest<Account> {
    ...
    fun `a new account should be empty`() {
        ...
        assertThat(account.balance).isEqualTo(Balance(0.0))
    }
    ...
    fun `a deposit should increase the amount of an account`() {
        ...
        assertThat(accountAfterDeposit.balance).isEqualTo(Balance(12.0))
    }
    ...
    fun `a withdrawal should decrease the amount of an account`() {
        ...
        assertThat(accountAfterDeposit.balance).isEqualTo(Balance(150.0))
    }
